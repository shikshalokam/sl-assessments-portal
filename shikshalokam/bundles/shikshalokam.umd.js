(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@angular/material/select'), require('@angular/common/http'), require('@angular/material/dialog'), require('@angular/material/button'), require('@angular/material/progress-spinner'), require('@angular/material/snack-bar'), require('ngx-spinner'), require('@angular/cdk/keycodes'), require('@angular/router'), require('@angular/forms'), require('jspdf'), require('html2canvas'), require('@angular/core'), require('angular-google-charts'), require('@angular/material/icon'), require('@angular/material'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('shikshalokam', ['exports', 'rxjs', 'rxjs/operators', '@angular/material/select', '@angular/common/http', '@angular/material/dialog', '@angular/material/button', '@angular/material/progress-spinner', '@angular/material/snack-bar', 'ngx-spinner', '@angular/cdk/keycodes', '@angular/router', '@angular/forms', 'jspdf', 'html2canvas', '@angular/core', 'angular-google-charts', '@angular/material/icon', '@angular/material', '@angular/common'], factory) :
    (factory((global.shikshalokam = {}),global.rxjs,global.rxjs.operators,global.ng.material.select,global.ng.common.http,global.ng.material.dialog,global.ng.material.button,global.ng.material['progress-spinner'],global.ng.material['snack-bar'],global.i2,global.ng.cdk.keycodes,global.ng.router,global.ng.forms,global.jspdf,global.html2canvas,global.ng.core,global.angularGoogleCharts,global.ng.material.icon,global.ng.material,global.ng.common));
}(this, (function (exports,rxjs,operators,select,http,dialog,button,progressSpinner,snackBar,i2,keycodes,router,i3,jspdf,html2canvas,i0,angularGoogleCharts,icon,material,i1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var UtilityService = /** @class */ (function () {
            ...
            function (inputs) {
                 ...
                 */function (element) {
                    if (element.input == "array") {
                        ...
                        group[element.field] = element.validation.required ? new i3.FormControl({ value: element.value || '', disabled: !element.editable }, i3.Validators.required)
                            : new i3.FormControl({ value: element.value || '', disabled: !element.editable });
                    }
                }));
                return new i3.FormGroup(group);
            };
        /**
         * @param {?} inputs
         * @return {?}
         ...
         */
            function (inputs) {
                 ...
                 * @return {?}
                 */function (element) {
                    elements[element['field']] = element.validation.required ? new i3.FormControl({ value: element.value || '', disabled: !element.editable }, i3.Validators.required)
                        : new i3.FormControl({ value: element.value || '', disabled: !element.editable });
                }));
                return new i3.FormArray(elements);
            };
        /**
         * @param {?} object
         * @return {?}
                    ...
                    if (field.input === "array") {
                         ...
                         */function (level) {
                            ...
                            controls.push(_this._formBuilder.group((_a = {},
                                _a[controlLabel] = [level ? level : '', i3.Validators.required],
                                _a)));
                        }));
                    }
                    else {
                        controls = new i3.FormControl(field.value ? field.value : "", field.validation.required ? i3.Validators.required : null);
                    }
         ...
         */
            function (object) {
                 ...
                 */function (field) {
                    ...
                    var controls;
                    if (field.input === "file") {
                        controls = new i3.FormControl(field.value ? field.value : null, [field.validation.required ? i3.Validators.required : null]);
                    }
                    _this.objectForm.addControl(field.field, controls);
                }));
    ...
    var BreadcrumbComponent = /** @class */ (function () {
        function BreadcrumbComponent(breadcrumbService, utilityService, activatedRoute, router$$1) {
            var _this = this;
        ...
        BreadcrumbComponent.propDecorators = {
            addClass: [{ type: i0.Input }],
            showControl: [{ type: i0.Input }],
    ...
    var DashboardBlocksComponent = /** @class */ (function () {
        function DashboardBlocksComponent(snackBar$$1) {
            this.snackBar = snackBar$$1;
            this.canAcess = localStorage.getItem('canAcess');
            this.sendNavigationLink = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        /** @nocollapse */
        DashboardBlocksComponent.ctorParameters = function () {
            return [
        ...
        DashboardBlocksComponent.propDecorators = {
            list: [{ type: i0.Input }],
            sendNavigationLink: [{ type: i0.Output }]
        };
    ...
    var DropdownFieldComponent = /** @class */ (function () {
        function DropdownFieldComponent() {
            this.emitResponseType = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        DropdownFieldComponent.propDecorators = {
            genericData: [{ type: i0.Input }],
            genericForm: [{ type: i0.Input }],
            genericEdit: [{ type: i0.Input }],
            emitResponseType: [{ type: i0.Output }]
        };
    ...
    var DynamicFormComponent = /** @class */ (function () {
        function DynamicFormComponent() {
            this.editnewquestion = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        DynamicFormComponent.propDecorators = {
            ...
            genericForm: [{ type: i0.Input }],
            genericEdit: [{ type: i0.Input }],
            editnewquestion: [{ type: i0.Output }],
            hostUrl: [{ type: i0.Input }]
        };
    ...
    var FormArrayFieldComponent = /** @class */ (function () {
        function FormArrayFieldComponent(_formBuilder) {
            this._formBuilder = _formBuilder;
            this.editquestion = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
         ...
         */
            function (control) {
                ...
                control.push(this._formBuilder.group((_a = {},
                    _a[this.genericData.field] = ['', i3.Validators.required],
                    _a)));
                this.questionCount++;
            };
        /**
        ...
        /** @nocollapse */
        FormArrayFieldComponent.ctorParameters = function () {
            return [
                { type: i3.FormBuilder }
            ];
        };
    ...
    var ParentHeadingComponent = /** @class */ (function () {
        function ParentHeadingComponent(dialog$$1, utilityService) {
            this.dialog = dialog$$1;
            this.utilityService = utilityService;
            this.sendMarkAsComplete = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        /** @nocollapse */
        ParentHeadingComponent.ctorParameters = function () {
            return [
        ...
        ParentHeadingComponent.propDecorators = {
            genericHeading: [{ type: i0.Input }],
            schoolName: [{ type: i0.Input }],
            startIndex: [{ type: i0.Input }],
            atleastOneComplete: [{ type: i0.Input }],
            schoolId: [{ type: i0.Input }],
            schoolNameDivider: [{ type: i0.Input }],
            showControl: [{ type: i0.Input }],
            sendMarkAsComplete: [{ type: i0.Output }]
        };
    ...
    var SearchDirective = /** @class */ (function () {
        function SearchDirective() {
            ...
            this.debounceSearch = new i0.EventEmitter();
         ...
         */
            function () {
                var _this = this;
                this.subscription = this.clicks.pipe(operators.debounceTime(this.debounceTime)).subscribe(( /**
                 * @param {?} e
                 * @return {?}
                 */function (e) {
        ...
        SearchDirective.propDecorators = {
            ...
            debounceSearch: [{ type: i0.Output }],
            clickEvent: [{ type: i0.HostListener, args: ['keyup', ['$event'],] }]
        };
    ...
    var ResourceService = /** @class */ (function () {
        ...
        /** @nocollapse */ ResourceService.ngInjectableDef = i0.defineInjectable({ factory: function ResourceService_Factory() { return new ResourceService(); }, token: ResourceService, providedIn: "root" });
    ...
    var GlobalConfigurationService = /** @class */ (function () {
        ...
        /** @nocollapse */
        GlobalConfigurationService.ctorParameters = function () {
            return [
                { type: ApiService }
            ];
        };
        /** @nocollapse */ GlobalConfigurationService.ngInjectableDef = i0.defineInjectable({ factory: function GlobalConfigurationService_Factory() { return new GlobalConfigurationService(i0.inject(ApiService)); }, token: GlobalConfigurationService, providedIn: "root" });
    ...
    var ProgramsDashboardComponent = /** @class */ (function () {
        function ProgramsDashboardComponent() {
            this.emitCurrentProgram = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        ProgramsDashboardComponent.propDecorators = {
            ...
            emitCurrentProgram: [{ type: i0.Output }]
        };
    ...
    var PaginationComponent = /** @class */ (function () {
        function PaginationComponent(_fb) {
            ...
            this.paginationResponse = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
         ...
         */
            function () {
                ...
                this.pageSize = this._fb.group({
                    pageLimit: [this.pagination.pageLimit, i3.Validators.required]
                });
        ...
        PaginationComponent.propDecorators = {
            ...
            paginationLabel: [{ type: i0.Input }],
            itemsPerPage: [{ type: i0.Input }],
            pageLimit: [{ type: i0.Input }],
            pageIndex: [{ type: i0.Input }],
            paginationResponse: [{ type: i0.Output }]
        };
    ...
    var AutoCompeteComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AutoCompeteComponent.ctorParameters = function () {
            return [
                { type: ApiService },
                { type: router.ActivatedRoute }
            ];
    ...
    var TableComponentComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                this.datas = new material.MatTableDataSource(this.datas);
            };
    ...
    var ShareLinkViewComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        ShareLinkViewComponent.ctorParameters = function () {
            return [
                { type: material.MatDialogRef },
                { type: undefined, decorators: [{ type: i0.Inject, args: [material.MAT_DIALOG_DATA,] }] }
            ];
    ...
    var ShareLinkComponent = /** @class */ (function () {
        function ShareLinkComponent(dialog$$1, snackBar$$1, utility, router$$1, route, apiService) {
            this.dialog = dialog$$1;
            this.snackBar = snackBar$$1;
        ...
        /** @nocollapse */
        ShareLinkComponent.ctorParameters = function () {
            return [
                { type: material.MatDialog },
                { type: material.MatSnackBar },
                { type: UtilityService },
        ...
        ShareLinkComponent.propDecorators = {
            publicSharedBaseUrl: [{ type: i0.Input }],
            shareLinkApi: [{ type: i0.Input }],
            globalConfig: [{ type: i0.Input }],
        ...
        SharedModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [
                            ...
                            angularGoogleCharts.GoogleChartsModule.forRoot(),
                            icon.MatIconModule
                        ],
    ...
    var ReportService = /** @class */ (function () {
        ...
        /** @nocollapse */ ReportService.ngInjectableDef = i0.defineInjectable({ factory: function ReportService_Factory() { return new ReportService(i0.inject(ApiService)); }, token: ReportService, providedIn: "root" });
    ...
    var EntityReportComponent = /** @class */ (function () {
        function EntityReportComponent(apiService, snackBar$$1, route, utility, router$$1) {
            var _this = this;
            this.apiService = apiService;
            this.snackBar = snackBar$$1;
            this.route = route;
        ...
        /** @nocollapse */
        EntityReportComponent.ctorParameters = function () {
            return [
                { type: ReportService },
                { type: material.MatSnackBar },
                { type: router.Router },
    ...
    var HighlevelEntityReportComponent = /** @class */ (function () {
        function HighlevelEntityReportComponent(apiService, utility, snackBar$$1, router$$1, route) {
            var _this = this;
            this.apiService = apiService;
            this.utility = utility;
            this.snackBar = snackBar$$1;
                    ...
                    try {
                        for (var _d = __values(_this.highLevelInsight['sections'][0]['subSections'][0].data), _e = _d.next(); !_e.done; _e = _d.next()) {
                            ...
                            try {
                                ...
                                try {
                                    if (totalCountArray_1_1 && !totalCountArray_1_1.done && (_b = totalCountArray_1.return))
                                        _b.call(totalCountArray_1);
                                }
                                finally {
                                    if (e_2)
                                        throw e_2.error;
                            ...
                            try {
                                ...
                                try {
                                    if (objKeys_1_1 && !objKeys_1_1.done && (_c = objKeys_1.return))
                                        _c.call(objKeys_1);
                                }
                                finally {
                                    if (e_3)
        ...
        /** @nocollapse */
        HighlevelEntityReportComponent.ctorParameters = function () {
            return [
                { type: ReportService },
                { type: UtilityService },
                { type: material.MatSnackBar },
    ...
    var MultipleEntityDrilldownReportComponent = /** @class */ (function () {
        function MultipleEntityDrilldownReportComponent(reportService, utility, snackBar$$1, route, router$$1) {
        ...
        /** @nocollapse */
        MultipleEntityDrilldownReportComponent.ctorParameters = function () {
            return [
                { type: ReportService },
                { type: UtilityService },
                { type: material.MatSnackBar },
    ...
    var MultipleEntityRportComponent = /** @class */ (function () {
        function MultipleEntityRportComponent(reportService, utility, snackBar$$1, route, router$$1) {
            this.reportService = reportService;
            this.utility = utility;
            this.snackBar = snackBar$$1;
            this.route = route;
        ...
        /** @nocollapse */
        MultipleEntityRportComponent.ctorParameters = function () {
            return [
                { type: ReportService },
                { type: UtilityService },
                { type: material.MatSnackBar },
    ...
    var OperationsService = /** @class */ (function () {
        ...
        /** @nocollapse */
        OperationsService.ctorParameters = function () {
            return [
                { type: ApiService }
            ];
        };
        /** @nocollapse */ OperationsService.ngInjectableDef = i0.defineInjectable({ factory: function OperationsService_Factory() { return new OperationsService(i0.inject(ApiService)); }, token: OperationsService, providedIn: "root" });
    ...
    var OpsReportComponent = /** @class */ (function () {
        function OpsReportComponent(router$$1, route, _fb, operationService, utility, snackBar$$1) {
            var _this = this;
            this.router = router$$1;
            this.route = route;
            this._fb = _fb;
            ...
            this.filterForm = this._fb.group({
                formDate: ['', i3.Validators.required],
                toDate: ['', i3.Validators.required]
            });
        }
        /**
         * @param {?} id
        ...
        /** @nocollapse */
        OpsReportComponent.ctorParameters = function () {
            return [
                { type: router.Router },
                { type: router.ActivatedRoute },
                { type: i3.FormBuilder },
        ...
        OpsReportComponent.propDecorators = {
            hostUrl: [{ type: i0.Input }],
            globalConfig: [{ type: i0.Input }],
            filterPanel: [{ type: i0.ViewChild, args: ['myaccordion',] }]
        };
    ...
    exports.DashboardBlocksComponent = DashboardBlocksComponent;
    exports.DialogBoxComponent = DialogBoxComponent;
    exports.DropdownFieldComponent = DropdownFieldComponent;
    exports.DynamicFormComponent = DynamicFormComponent;
    exports.FormArrayFieldComponent = FormArrayFieldComponent;
    exports.ImageCardComponent = ImageCardComponent;
    exports.LoaderComponent = LoaderComponent;
    exports.NumberFieldComponent = NumberFieldComponent;
    exports.ParentHeadingComponent = ParentHeadingComponent;
    ...
    exports.ProgramsDashboardComponent = ProgramsDashboardComponent;
    exports.MinCharacterPipe = MinCharacterPipe;
    exports.BreadcrumbsService = BreadcrumbsService;
    exports.PaginationComponent = PaginationComponent;
    exports.DatePickerComponent = DatePickerComponent;
    exports.IndividualLoaderComponent = IndividualLoaderComponent;
    exports.GraphTableChartComponent = GraphTableChartComponent;
    exports.ShareLinkComponent = ShareLinkComponent;
    exports.EntityReportComponent = EntityReportComponent;
    exports.HighlevelEntityReportComponent = HighlevelEntityReportComponent;
    exports.MultipleEntityDrilldownReportComponent = MultipleEntityDrilldownReportComponent;
    exports.MultipleEntityRportComponent = MultipleEntityRportComponent;
    exports.OpsReportComponent = OpsReportComponent;
    exports.ReportModule = ReportModule;
    exports.FileUploadComponent = FileUploadComponent;
    exports.ɵf = AppContainerComponent;
    exports.ɵh = OperationsService;
    exports.ɵg = ReportService;
    exports.ɵa = AutoCompeteComponent;
    exports.ɵe = ChipsFieldComponent;
    exports.ɵc = ColumnGraphComponent;
    exports.ɵb = TableComponentComponent;
    exports.ɵd = ShareLinkViewComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=shikshalokam.umd.js.map